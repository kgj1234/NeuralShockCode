function compare_ratios_big_shock_window(bigbox,shockbox,field,flatten_option)
...
mkdir(horzcat(main_path,'ShockBox BigBox Comparisons Window'), horzcat('Comparison',field,flatten_option,'Ratio'));
Comparison_Path=horzcat(main_path,'ShockBox BigBox Comparisons Window\', horzcat('Comparison',field,flatten_option,'Ratio\'));
...
save(horzcat(main_path,'BigBoxWindow\Data\','bigbox',field,flatten_option,'.mat'),'bigboxval')
save(horzcat(main_path,'ShockBoxWindow\Data\','shockbox',field,flatten_option,'.mat'),'shockboxval')
figs=plot_heatmap(bigboxval,'neurons','experiments',flatten_option,false);
saveas(figs,horzcat(main_path,'BigBoxWindow\Figures\','bigbox',field,flatten_option,'.png'),'png')
close all


figs=plot_heatmap(bigboxval,'neurons','experiments',flatten_option,true);
saveas(figs,horzcat(main_path,'BigBoxWindow\Figures\','bigbox',field,flatten_option,'Normalized.png'),'png')
close all
figs=plot_heatmap(shockboxval,'neurons','experiments',flatten_option,false);
saveas(figs,horzcat(main_path,'ShockBoxWindow\Figures\','shockbox',field,flatten_option,'.png'),'png')
close all


figs=plot_heatmap(shockboxval,'neurons','experiments',flatten_option,true);
saveas(figs,horzcat(main_path,'ShockBoxWindow\Figures\','shockbox',field,flatten_option,'Normalized.png'),'png')
close all
